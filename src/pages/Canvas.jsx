...
const Canvas = () => {
  ...
  const menuAsideBf = `w-1/5 h-4/5 absolute text-xs text-white  flex item-center top-20 hidden bg-background rounded-lg flex flex-col border border-emerald-500 shadow-stock shadow-xl/20`;
  const menuRightBf = `h-40 w-25 bg-background absolute top-18 right-8 rounded text-white flex flex-col items-center justify-around px-2 py-2 gap-1 `;
  const menuRightAf = `h-40 w-25 bg-background absolute top-18 hidden rounded text-white flex flex-col items-center justify-around px-2 py-2 gap-1`;
    ...
    <>
      <div className="h-full w-full relative">
        <div className="absolute h-screen w-full ">
          ...
          <aside className={clickedL ? menuAsideBf : menuAsideAf}>
        ...
        <canvas className="h-full w-full bg-canvas"></canvas>
      </div>
    </>
  );
};
